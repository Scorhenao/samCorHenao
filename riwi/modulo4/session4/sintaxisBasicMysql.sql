...
/*inner join*/
SELECT `PACIENTES`.NOMBRE, `PACIENTES`.APELLIDOS, `TIPO_DOCUMENTO`.NOMBRE_TIPO_DOCUMENTO,`PACIENTES`.NUMERO_DOCUMENTO FROM PACIENTES /*SE SELECCIONA LA INFORMACION QUE SE QUIERE SACAR, COMO YA TENEMOS LA OTRA TABLA INSERTADA COMO UN OBJETO SE PUEDE ACCEDER A ESTE*/
