#elabore un algoritmo que lea un numero entero  menor que 32768 y que efectue lo siguiente: si es multiplo de 4, imprimir el numero dividido por 4, si es multiplo de 5, imprimir la quinta parte del numero elevada al cuadrado, si es multiplo de 7 imprimir el numero dividido por 8 y si no es multiplo de ninguno de los anteriores producir el mensaje 'numero extraño'
...
if num > 32768:
    ...
    if num % 4 == 0:
        ...
        if num % 5 == 0:
            ...
            if num % 7 == 0:
                print(f"el numero {num} es multiplo de 7 y fue dividido por 8 = {num_div8}")
            else:
